 ...
 * Run: GOOGLE_CLOUD_PROJECT=yellowcircle-app node reseed-montreal.js
 */

const admin = require('firebase-admin');

// Initialize with default credentials (from environment or gcloud)
admin.initializeApp({

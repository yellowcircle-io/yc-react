...
// Base template component for all pages
function PageTemplate({ pageTitle = "HOME", titleColor = "black", backgroundImages = null, backgroundColor = null }) {
  ...
  return (
    <div style={{ 
      ...
      {/* Background System - Customizable */}
      <div className="scrollable-area" style={{
        ...
        ...(backgroundImages ? {
          ...
          backgroundColor: backgroundColor ? backgroundColor[0] : 'white'
        }),
        zIndex: 10,
      ...
      <div className="scrollable-area" style={{
        ...
        ...(backgroundImages ? {
          ...
          backgroundColor: backgroundColor ? backgroundColor[1] : '#EECF00'
        }),
        zIndex: 11,
        transition: 'left 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)'
      }}></div>
      ...
      <div className="scrollable-area" style={{
        ...
        ...(backgroundImages ? {
          ...
          backgroundColor: backgroundColor ? backgroundColor[2] : 'red'
        }),
        zIndex: 12,
        transition: 'left 0.3s cubic-bezier(0.25, 0.46, 0.45, 0.94)'
      }}></div>
      ...
      <div style={{
        ...
        {/* Page Title Label - Fixed pixel position, customizable */}
        <div style={{ 
          position: 'absolute',
          top: '100px',
          left: '40px',
...
// HomePage component using the template
function HomePage() {
  const homeBackgroundImages = [
    'https://res.cloudinary.com/yellowcircle-io/image/upload/v1756494388/background_f7cdue.png',
    'https://res.cloudinary.com/yellowcircle-io/image/upload/v1756513503/Group_34_tfqn6y.png',
    'https://res.cloudinary.com/yellowcircle-io/image/upload/v1756512745/bg-3_xbayq3.png'
  ];
...
// ExperimentsPage component using the template with placeholder colors
function ExperimentsPage() {
  const experimentColors = ['white', '#EECF00', 'red'];

  return (
    <PageTemplate 
      pageTitle="EXP."
      titleColor="#EECF00"
      backgroundColor={experimentColors}
    />
  );
}

        ...
        <div style={{ ...TYPOGRAPHY.container }}>
          ...
          <div style={{ position: 'relative', minHeight: '120px' }}>
            <p style={{
              ...
              Poetry meets rhythm in generative form
            </p>
          </div>
          ...
          <p style={{
            ...
            An exploration of poetic generation combining rhythm, meaning, and interactive visual design.
          </p>
        </div>
      </div>
    </Layout>

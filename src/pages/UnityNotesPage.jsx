...
const UnityNotesFlow = ({ isUploadModalOpen, setIsUploadModalOpen, onFooterToggle, showParallax, setShowParallax }) => {
  ...
  // Custom accent color state - persisted to localStorage (used by future theme system)
  ...
  const _currentAccentColor = accentColors[customAccentColor] || accentColors.amber;
  ...
  return (
    <div style={{ width: '100%', height: '100%', position: 'relative', zIndex: 20 }}>
      ...
      <UnityCircleNav
        ...
        onBackgroundChange={setBackgroundPattern}
      />

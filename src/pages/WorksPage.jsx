          ...
          <nav className="flex-1 space-y-2">
            ...
            <div className="space-y-1">
              <button 
                ...
                className="w-full text-left p-3 hover:bg-gray-100 rounded-lg transition-colors duration-200 flex items-center justify-between bg-green-50 border border-green-200"
              ...
              {expandedAccordionItems.has('works') && (
                <div className="ml-8 space-y-1 overflow-hidden">
                  <button 
                    ...
                    className="block w-full text-left p-2 text-sm text-green-600 hover:text-green-900 hover:bg-green-50 rounded transition-colors duration-200"
                  >
                    All Works
                  </button>
                  <button 
